// 초등학교 6학년 및 아케이드 감성의 타자 연습 데이터셋 (한국어 & 영어)

export const TYPING_DATA = {
  ko: {
    word: [
      "필살기", "대사격", "오로치", "삼신기", "무술가", "콤보", "타격감", "스트리트",
      "승리", "도전자", "챔피언", "격투가", "번개", "불꽃", "초필살기", "아케이드",
    ...
    short: [
      ...
      "동해물과 백두산이 마르고 닳도록 보우하사.",
      "실패는 성공으로 가는 과정의 이정표이다.",
      "친구와 함께하는 협동은 어떤 난관도 극복한다.",
      "새로운 시작은 언제나 우리 가슴을 설레게 한다.",
      "아름다운 우리 한글을 사랑하고 바르게 쓰자.",
      "끈기 있는 타자 연습이 무적의 챔피언을 만든다.",
      "하늘을仰望하여 한 점 부끄럼 없기를 바란다."
    ],
    long: [
      "죽는 날까지 하늘을仰望하여 한 점 부끄럼이 없기를, 잎새에 이는 바람에도 나는 괴로워했다.",
      "동해 물과 백두산이 마르고 닳도록 하나님이 보우하사 우리나라 만세, 무궁화 삼천리 화려 강산.",
      "나에게 포기란 없다! 어떤 거센 폭풍우가 밀려와도 나는 나의 길을 당당히 걸어갈 것이다.",
      "오늘 흘린 땀방울은 내일의 위대한 영광이 되어 반드시 나에게 가장 눈부신 결실로 돌아온다.",
      "컴퓨터 언어를 배우고 인공지능 시대를 선도하는 창의적인 인재로 힘차게 성장해 나가자.",
      "어둠이 깊어질수록 별은 더욱 빛나고, 고난이 클수록 위대한 격투가의 의지는 강해진다.",
      "서로를 존중하고 배려하는 따뜻한 마음이 이 세상을 더욱 아름답고 밝게 변화시킨다."
    ]
  },
  en: {
    word: [
    ...
    short: [
      ...
      "Speed and accuracy are the keys to victory in battle.",
    ...
    long: [
      ...
      "Great power comes with great responsibility. Stand tall, type fast, and claim your legendary championship title!"
    ]
  }
};
